...
public interface ConstraintPackage extends EPackage
{
	 ...
	 * @ordered
	 */
	int INVARIANT_CONSTRAINT__DOCUMENTATION = NamespacePackage.NAMED_ELEMENT__DOCUMENTATION;
	 ...
	 * @ordered
	 */
	int INVARIANT_CONSTRAINT__ANNOTATIONS = NamespacePackage.NAMED_ELEMENT__ANNOTATIONS;
	 ...
	 * @ordered
	 */
	int INVARIANT_CONSTRAINT_FEATURE_COUNT = NamespacePackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
