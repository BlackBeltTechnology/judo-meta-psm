...
/**
  * <!-- begin-user-doc -->
  *   A builder for the model object ' <em><b>hu.blackbelt.judo.meta.psm.derived.NavigationProperty</b></em>'.
  * <!-- end-user-doc -->
  *
  * @generated
  */
public class NavigationPropertyBuilder implements IDerivedBuilder<hu.blackbelt.judo.meta.psm.derived.NavigationProperty> {
    private  hu.blackbelt.judo.meta.psm.derived.NavigationProperty $instance = null;
     ...
     */
    public NavigationPropertyBuilder but() {
           NavigationPropertyBuilder _builder = create();
    ...
    /**
     * This method constructs the final hu.blackbelt.judo.meta.psm.derived.NavigationProperty type.
     * @return new instance of the hu.blackbelt.judo.meta.psm.derived.NavigationProperty type
     */
    public hu.blackbelt.judo.meta.psm.derived.NavigationProperty build() {

        final hu.blackbelt.judo.meta.psm.derived.NavigationProperty _instance;

        if ($instance == null) {
            _instance = hu.blackbelt.judo.meta.psm.derived.DerivedFactory.eINSTANCE.createNavigationProperty();
        } else {
            _instance = $instance;
        }
        ...
        if (m_nullCheck && _instance.getCardinality() == null) {
            throw new IllegalArgumentException("Mandatory \"cardinality\" attribute is missing from NavigationPropertyBuilder.");
        }
        if (m_nullCheck && _instance.getGetterExpression() == null) {
            throw new IllegalArgumentException("Mandatory \"getterExpression\" attribute is missing from NavigationPropertyBuilder.");
        }
        if (m_nullCheck && _instance.getName() == null) {
            throw new IllegalArgumentException("Mandatory \"name\" attribute is missing from NavigationPropertyBuilder.");
        }
        if (m_nullCheck && _instance.getTarget() == null) {
            throw new IllegalArgumentException("Mandatory \"target\" attribute is missing from NavigationPropertyBuilder.");
        }
        return _instance;
    }
     ...
     * @see DerivedBuilders#newNavigationPropertyBuilder()
     */
    private NavigationPropertyBuilder() {
    }


    /**
     * Builder is not instantiated with an instance.
     * @see  DerivedBuilders#useNavigationPropertyBuilder()
     */
    private NavigationPropertyBuilder(hu.blackbelt.judo.meta.psm.derived.NavigationProperty instance) {
        $instance = instance;
    }

    /**
     * This method creates a new instance of the NavigationPropertyBuilder.
     * @return new instance of the NavigationPropertyBuilder
     */
    public static NavigationPropertyBuilder create() {
        return new NavigationPropertyBuilder();
    }

    /**
     * This method creates a new instance of the NavigationPropertyBuilder with mandatory field check if nullCheck is true.
     * @return new instance of the NavigationPropertyBuilder
     */
    public static NavigationPropertyBuilder create(boolean p_nullCheck) {
        return new NavigationPropertyBuilder().withNullCheck(p_nullCheck);
    }

    /**
     * This method creates a new instance of the NavigationPropertyBuilder from the given instance of class.
     * @return new instance of the NavigationPropertyBuilder
     */
    public static NavigationPropertyBuilder use(hu.blackbelt.judo.meta.psm.derived.NavigationProperty instance) {
        return new NavigationPropertyBuilder(instance);
    }

    /**
     * This method creates a new instance of the NavigationPropertyBuilder from the given instance of class with mandatory field check if nullCheck is true.
     * @return new instance of the NavigationPropertyBuilder
     */
    public static NavigationPropertyBuilder use(hu.blackbelt.judo.meta.psm.derived.NavigationProperty instance, boolean p_nullCheck) {
        return new NavigationPropertyBuilder(instance).withNullCheck(p_nullCheck);
    }

    private NavigationPropertyBuilder withNullCheck(boolean p_nullCheck){
        m_nullCheck = p_nullCheck;
        return this;
    }

     public NavigationPropertyBuilder withCardinality(hu.blackbelt.judo.meta.psm.type.Cardinality p_cardinality){
         m_cardinality = p_cardinality;
         m_featureCardinalitySet = true;
         return this;
     }
     public NavigationPropertyBuilder withCardinality(hu.blackbelt.judo.meta.psm.type.util.builder.ITypeBuilder<? extends hu.blackbelt.judo.meta.psm.type.Cardinality> p_navigationPropertyBuilder){
         m_featureCardinalityBuilder = p_navigationPropertyBuilder;
         return this;
     }
     public NavigationPropertyBuilder withDocumentation(java.lang.String p_documentation){
         m_documentation = p_documentation;
         m_featureDocumentationSet = true;
         return this;
     }
     public NavigationPropertyBuilder withGetterExpression(hu.blackbelt.judo.meta.psm.derived.ReferenceExpressionType p_getterExpression){
         m_getterExpression = p_getterExpression;
         m_featureGetterExpressionSet = true;
         return this;
     }
     public NavigationPropertyBuilder withGetterExpression(hu.blackbelt.judo.meta.psm.derived.util.builder.IDerivedBuilder<? extends hu.blackbelt.judo.meta.psm.derived.ReferenceExpressionType> p_navigationPropertyBuilder){
         m_featureGetterExpressionBuilder = p_navigationPropertyBuilder;
         return this;
     }
     public NavigationPropertyBuilder withName(java.lang.String p_name){
         m_name = p_name;
         m_featureNameSet = true;
         return this;
     }
     public NavigationPropertyBuilder withSetterExpression(hu.blackbelt.judo.meta.psm.derived.ReferenceSelectorType p_setterExpression){
         m_setterExpression = p_setterExpression;
         m_featureSetterExpressionSet = true;
         return this;
     }
     public NavigationPropertyBuilder withSetterExpression(hu.blackbelt.judo.meta.psm.derived.util.builder.IDerivedBuilder<? extends hu.blackbelt.judo.meta.psm.derived.ReferenceSelectorType> p_navigationPropertyBuilder){
         m_featureSetterExpressionBuilder = p_navigationPropertyBuilder;
         return this;
     }
     public NavigationPropertyBuilder withTarget(hu.blackbelt.judo.meta.psm.data.EntityType p_target){
         m_target = p_target;
         m_featureTargetSet = true;
         return this;
     }
     public NavigationPropertyBuilder withTarget(hu.blackbelt.judo.meta.psm.data.util.builder.IDataBuilder<? extends hu.blackbelt.judo.meta.psm.data.EntityType> p_navigationPropertyBuilder){
         m_featureTargetBuilder = p_navigationPropertyBuilder;
         return this;
     }

     public NavigationPropertyBuilder withAnnotations(hu.blackbelt.judo.meta.psm.namespace.Annotation p_annotations){
         m_annotations.add(p_annotations);
         m_featureAnnotationsSet = true;
         return this;
     }
     
     public NavigationPropertyBuilder withAnnotations(java.util.Collection<? extends hu.blackbelt.judo.meta.psm.namespace.Annotation> p_annotations){
     ...
     public NavigationPropertyBuilder withAnnotations(hu.blackbelt.judo.meta.psm.namespace.util.builder.INamespaceBuilder<? extends hu.blackbelt.judo.meta.psm.namespace.Annotation> p_navigationPropertyBuilder){
