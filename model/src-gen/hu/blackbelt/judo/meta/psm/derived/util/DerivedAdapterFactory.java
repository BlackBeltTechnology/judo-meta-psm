...
public class DerivedAdapterFactory extends AdapterFactoryImpl
{
	...
	protected DerivedSwitch<Adapter> modelSwitch =
		new DerivedSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseReferenceExpressionType(ReferenceExpressionType object)
			{
				return createReferenceExpressionTypeAdapter();
			}
			@Override
			public Adapter caseReferenceSelectorType(ReferenceSelectorType object)
			{
				return createReferenceSelectorTypeAdapter();
			}
			@Override
			public Adapter caseDataExpressionType(DataExpressionType object)
			{
				return createDataExpressionTypeAdapter();
			}
			@Override
			public Adapter caseAttributeSelectorType(AttributeSelectorType object)
			{
				return createAttributeSelectorTypeAdapter();
			}
			@Override
			public Adapter caseLogicalExpressionType(LogicalExpressionType object)
			{
				return createLogicalExpressionTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.psm.derived.ExpressionType <em>Expression Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.psm.derived.ReferenceExpressionType <em>Reference Expression Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createReferenceExpressionTypeAdapter()
	{
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.psm.derived.ReferenceSelectorType <em>Reference Selector Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createReferenceSelectorTypeAdapter()
	{
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.psm.derived.DataExpressionType <em>Data Expression Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDataExpressionTypeAdapter()
	{
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.psm.derived.AttributeSelectorType <em>Attribute Selector Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAttributeSelectorTypeAdapter()
	{
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.psm.derived.LogicalExpressionType <em>Logical Expression Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLogicalExpressionTypeAdapter()
	{
		return null;
	}
