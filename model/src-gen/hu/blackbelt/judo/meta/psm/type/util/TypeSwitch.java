...
public class TypeSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case TypePackage.CUSTOM_TYPE:
			{
				...
				if (result == null) result = caseFlatPrimitiveType(customType);
			...
			case TypePackage.STRING_TYPE:
			{
				...
				if (result == null) result = caseFlatPrimitiveType(stringType);
			...
			case TypePackage.NUMERIC_TYPE:
			{
				...
				if (result == null) result = caseFlatPrimitiveType(numericType);
			...
			case TypePackage.BOOLEAN_TYPE:
			{
				...
				if (result == null) result = caseFlatPrimitiveType(booleanType);
			...
			case TypePackage.XML_TYPE:
			{
				...
				if (result == null) result = caseFlatPrimitiveType(xmlType);
			...
			case TypePackage.PASSWORD_TYPE:
			{
				...
				if (result == null) result = caseFlatPrimitiveType(passwordType);
			...
			case TypePackage.DATE_TYPE:
			{
				...
				if (result == null) result = caseFlatPrimitiveType(dateType);
			...
			case TypePackage.TIMESTAMP_TYPE:
			{
				...
				if (result == null) result = caseFlatPrimitiveType(timestampType);
			...
			case TypePackage.FLAT_PRIMITIVE_TYPE:
			{
				FlatPrimitiveType flatPrimitiveType = (FlatPrimitiveType)theEObject;
				T result = caseFlatPrimitiveType(flatPrimitiveType);
				if (result == null) result = casePrimitive(flatPrimitiveType);
				if (result == null) result = caseDataType(flatPrimitiveType);
				if (result == null) result = caseType(flatPrimitiveType);
				if (result == null) result = caseNamespaceElement(flatPrimitiveType);
				if (result == null) result = caseNamedElement(flatPrimitiveType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TypePackage.BINARY_TYPE:
			{
				BinaryType binaryType = (BinaryType)theEObject;
				T result = caseBinaryType(binaryType);
				if (result == null) result = caseFlatPrimitiveType(binaryType);
				if (result == null) result = casePrimitive(binaryType);
				if (result == null) result = caseDataType(binaryType);
				if (result == null) result = caseType(binaryType);
				if (result == null) result = caseNamespaceElement(binaryType);
				if (result == null) result = caseNamedElement(binaryType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TypePackage.TIME_TYPE:
			{
				TimeType timeType = (TimeType)theEObject;
				T result = caseTimeType(timeType);
				if (result == null) result = caseFlatPrimitiveType(timeType);
				if (result == null) result = casePrimitive(timeType);
				if (result == null) result = caseDataType(timeType);
				if (result == null) result = caseType(timeType);
				if (result == null) result = caseNamespaceElement(timeType);
				if (result == null) result = caseNamedElement(timeType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Flat Primitive Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Flat Primitive Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFlatPrimitiveType(FlatPrimitiveType object)
	{
		return null;
	}
