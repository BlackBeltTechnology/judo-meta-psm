...
public class InternationalOrderInfo {
    ...
    public BoundTransferOperation updateInstanceNorthwind_services_InternationalOrderInfo = newBoundTransferOperationBuilder().build();
    ...
    public void init(Package $package, String $string, Double $double, InternationalOrder $internationalOrder,
        ...
        useMappedTransferObjectType($)
                ...
                .withOperations(useBoundTransferOperation(updateInstanceNorthwind_services_InternationalOrderInfo)
                        .withName("_updateInstanceNorthwind_services_InternationalOrderInfo")
                        .withBinding($internationalOrder.updateInstanceForNorthwind_services_InternationalOrderInfo)
                        .withBehaviour(newTransferOperationBehaviourBuilder()
                ...
                .withOperations(useBoundTransferOperation(deleteInstanceNorthwind_services_InternationalOrderInfo)
                        .withName("_deleteInstanceNorthwind_services_InternationalOrderInfo")
                        .withBinding($internationalOrder.deleteInstanceForNorthwind_services_InternationalOrderInfo)
                        .withBehaviour(newTransferOperationBehaviourBuilder()
                ...
                .withOperations(useBoundTransferOperation(refreshInstanceNorthwind_services_OrderInfo)
                        ...
                        .withBinding($internationalOrder.refreshInstanceForNorthwind_services_InternationalOrderInfo)
                        .withBehaviour(newTransferOperationBehaviourBuilder()
