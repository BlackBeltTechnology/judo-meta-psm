...
class PsmValidationServiceTest {
	...
	void testOverridingWithValidInput() throws Exception {
		...
		BoundOperation operation1 = newBoundOperationBuilder().withName("operation1")
				.withInput(newParameterBuilder().withName("input").withType(correctType)
						.withCardinality(newCardinalityBuilder().build()))
				.withOutput(newParameterBuilder().withName("output").withType(correctType)
						.withCardinality(newCardinalityBuilder().build()))
				.build();
		...
		BoundOperation overriden2 = newBoundOperationBuilder().withName("operation2")
				.withInput(newParameterBuilder().withName("input").withType(wrongType)
						.withCardinality(newCardinalityBuilder().build()))
				.withOutput(newParameterBuilder().withName("output").withType(correctType)
						.withCardinality(newCardinalityBuilder().build()))
				.build();
		...
		BoundOperation operation3 = newBoundOperationBuilder().withName("operation3")
				...
				.withOutput(newParameterBuilder().withName("output").withType(correctType)
						.withCardinality(newCardinalityBuilder().build()))
				.build();
		BoundOperation overriden3 = newBoundOperationBuilder().withName("operation3").withOutput(newParameterBuilder()
				.withName("output").withType(correctType).withCardinality(newCardinalityBuilder().build())).build();

		BoundOperation operation4 = newBoundOperationBuilder().withName("operation4").withOutput(newParameterBuilder()
				.withName("output").withType(correctType).withCardinality(newCardinalityBuilder().build())).build();
		...
		MappedTransferObjectType transferObjectType0 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType0").withEntityType(entityType0)
				.withOperations(ImmutableList.of(operation1, operation2, operation3)).build();

		EntityType entityType1 = newEntityTypeBuilder().withName("entityType1").withSuperEntityTypes(entityType0)
				.build();
		MappedTransferObjectType transferObjectType1 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType1").withEntityType(entityType1)
				.withSuperTransferObjectTypes(transferObjectType0).withOperations(overriden1).build();

		EntityType entityType2 = newEntityTypeBuilder().withName("entityType2").withSuperEntityTypes(entityType0)
				.build();
		MappedTransferObjectType transferObjectType2 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType2").withEntityType(entityType2)
				.withSuperTransferObjectTypes(transferObjectType0)
				.withOperations(ImmutableList.of(operation4, overriden2)).build();

		EntityType entityType3 = newEntityTypeBuilder().withName("entityType3").withSuperEntityTypes(entityType2)
				.build();
		MappedTransferObjectType transferObjectType3 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType3").withEntityType(entityType3)
				.withSuperTransferObjectTypes(transferObjectType2)
				.withOperations(ImmutableList.of(overriden1, overriden4)).build();
		...
		MappedTransferObjectType transferObjectType4 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType4").withEntityType(entityType4)
				.withSuperTransferObjectTypes(ImmutableList.of(transferObjectType1, transferObjectType3))
				.withOperations(ImmutableList.of(overriden1, overriden3)).build();

		Model model = newModelBuilder().withName("M")
				.withElements(ImmutableList.of(correctType, wrongType, entityType0, entityType1, entityType2,
						entityType3, entityType4, transferObjectType0, transferObjectType1, transferObjectType2,
						transferObjectType3, transferObjectType4))
				.build();
	...
	void testOverridingWithValidOutput() throws Exception {
		...
		BoundOperation overriden2 = newBoundOperationBuilder().withName("operation2")
				.withInput(newParameterBuilder().withName("input").withType(correctType)
						.withCardinality(newCardinalityBuilder().build()))
				.withOutput(newParameterBuilder().withName("output").withType(wrongType)
						.withCardinality(newCardinalityBuilder().build()))
				.build();
		...
		BoundOperation operation3 = newBoundOperationBuilder().withName("operation3")
				...
				.withOutput(newParameterBuilder().withName("output").withType(correctType)
						.withCardinality(newCardinalityBuilder().build()))
				.build();
		BoundOperation overriden3 = newBoundOperationBuilder().withName("operation3").withInput(newParameterBuilder()
				.withName("input").withType(correctType).withCardinality(newCardinalityBuilder().build())).build();

		BoundOperation operation4 = newBoundOperationBuilder().withName("operation4").withInput(newParameterBuilder()
				.withName("input").withType(correctType).withCardinality(newCardinalityBuilder().build())).build();
		BoundOperation overriden4 = newBoundOperationBuilder().withName("operation4")
				.withInput(newParameterBuilder().withName("input").withType(correctType)
						.withCardinality(newCardinalityBuilder().build()))
	...
	void testInheritedBoundOperationHasNoImplementation() throws Exception {
		...
		MappedTransferObjectType transferObjectType1 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType1").withEntityType(entityType1)
				.withSuperTransferObjectTypes(transferObjectType0).withOperations(withImplementation2).build();

		EntityType entityType2 = newEntityTypeBuilder().withName("entityType2").withSuperEntityTypes(entityType0)
				.build();
		MappedTransferObjectType transferObjectType2 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType2").withEntityType(entityType2)
				.withSuperTransferObjectTypes(transferObjectType0).withOperations(correctOperation2).build();

		EntityType entityType3 = newEntityTypeBuilder().withName("entityType3").withSuperEntityTypes(entityType2)
				.build();
		MappedTransferObjectType transferObjectType3 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType3").withEntityType(entityType3)
				.withSuperTransferObjectTypes(transferObjectType2).withOperations(withImplementation3).build();
		...
		MappedTransferObjectType transferObjectType4 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType4").withEntityType(entityType4)
				.withSuperTransferObjectTypes(ImmutableList.of(transferObjectType1, transferObjectType3))
				.withOperations(ImmutableList.of(opWithoutImpl, correctOperation3)).build();

		Model model = newModelBuilder().withName("M")
				.withElements(ImmutableList.of(type, entityType0, entityType1, entityType2, entityType3, entityType4,
						transferObjectType0, transferObjectType1, transferObjectType2, transferObjectType3,
						transferObjectType4))
				.build();
	...
	void testNeedToOverrideMultipleOperationImplementations() throws Exception {
		...
		MappedTransferObjectType correctTransferObjectType0 = newMappedTransferObjectTypeBuilder()
				.withName("correctTransferObjectType0").withEntityType(correctEntityType0)
		...
		MappedTransferObjectType correctTransferObjectType1 = newMappedTransferObjectTypeBuilder()
				.withName("correctTransferObjectType1").withEntityType(correctEntityType1)
				.withSuperTransferObjectTypes(correctTransferObjectType0).withOperations(correctOperation2).build();
		...
		MappedTransferObjectType correctTransferObjectType2 = newMappedTransferObjectTypeBuilder()
				.withName("correctTransferObjectType2").withEntityType(correctEntityType2)
				.withSuperTransferObjectTypes(correctTransferObjectType1).build();
		...
		EntityType entityType0 = newEntityTypeBuilder().withName("entityType0").build();
		MappedTransferObjectType transferObjectType0 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType0").withEntityType(entityType0).withOperations(withImplementation1)
				.build();
		...
		EntityType entityType3 = newEntityTypeBuilder().withName("entityType3").withSuperEntityTypes(entityType0)
				.build();
		MappedTransferObjectType transferObjectType3 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType3").withEntityType(entityType3)
				.withSuperTransferObjectTypes(transferObjectType0).withOperations(withImplementation3).build();

		EntityType entityType4 = newEntityTypeBuilder().withName("entityType4").withSuperEntityTypes(entityType1)
				.build();
		MappedTransferObjectType transferObjectType4 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType4").withEntityType(entityType4)
				.withSuperTransferObjectTypes(transferObjectType1).withOperations(withImplementation3).build();

		EntityType entityType5 = newEntityTypeBuilder().withName("entityType5").withSuperEntityTypes(entityType2)
				.build();
		MappedTransferObjectType transferObjectType5 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType5").withEntityType(entityType5)
				.withSuperTransferObjectTypes(transferObjectType2).build();

		EntityType entityType6 = newEntityTypeBuilder().withName("entityType6")
				.withSuperEntityTypes(ImmutableList.of(entityType3, entityType4, entityType5)).build();
		MappedTransferObjectType transferObjectType6 = newMappedTransferObjectTypeBuilder()
				.withName("transferObjectType6").withEntityType(entityType6).withSuperTransferObjectTypes(
						ImmutableList.of(transferObjectType3, transferObjectType4, transferObjectType5))
				.build();

		Model model = newModelBuilder().withName("M")
				.withElements(ImmutableList.of(type, correctEntityType0, correctEntityType1, correctEntityType2,
						correctTransferObjectType0, correctTransferObjectType1, correctTransferObjectType2, entityType0,
						entityType1, entityType2, entityType3, entityType4, entityType5, entityType6,
						transferObjectType0, transferObjectType1, transferObjectType2, transferObjectType3,
						transferObjectType4, transferObjectType5, transferObjectType6))
				.build();
	...
	void testEntityTypeMatchesEntityTypeOfBaseMappedTransferObject() throws Exception {
		...
		MappedTransferObjectType parentTransferObject1 = newMappedTransferObjectTypeBuilder()
				.withName("parentTransferObject1").withEntityType(entityType1).build();
		MappedTransferObjectType parentTransferObject2 = newMappedTransferObjectTypeBuilder()
				.withName("parentTransferObject2").withEntityType(entityType2).build();
		MappedTransferObjectType childTransferObject1 = newMappedTransferObjectTypeBuilder()
				.withName("childTransferObject1").withEntityType(entityType2)
				.withSuperTransferObjectTypes(ImmutableList.of(parentTransferObject1, parentTransferObject2)).build();
		MappedTransferObjectType childTransferObject2 = newMappedTransferObjectTypeBuilder()
				.withName("childTransferObject2").withEntityType(entityType3)
				.withSuperTransferObjectTypes(ImmutableList.of(parentTransferObject1, parentTransferObject2)).build();

		EntityType parentEntityType3 = newEntityTypeBuilder().withName("parentEntityType3").build();
		EntityType parentEntityType4 = newEntityTypeBuilder().withName("parentEntityType4")
				.withSuperEntityTypes(parentEntityType3).build();
		EntityType childEntityType = newEntityTypeBuilder().withName("childEntityType")
				.withSuperEntityTypes(parentEntityType4).build();

		MappedTransferObjectType parentTransferObject3 = newMappedTransferObjectTypeBuilder()
				.withName("parentTransferObject3").withEntityType(parentEntityType3).build();
		MappedTransferObjectType parentTransferObject4 = newMappedTransferObjectTypeBuilder()
				.withName("parentTransferObject4").withEntityType(childEntityType)
				.withSuperTransferObjectTypes(parentTransferObject3).build();
		MappedTransferObjectType childTransferObject3 = newMappedTransferObjectTypeBuilder()
				.withName("childTransferObject3").withEntityType(parentEntityType4)
				.withSuperTransferObjectTypes(parentTransferObject4).build();

		Model model = newModelBuilder().withName("M")
				.withElements(ImmutableList.of(entityType1, entityType2, entityType3, childEntityType,
						parentTransferObject1, parentTransferObject2, parentTransferObject3, parentTransferObject4,
						childTransferObject1, childTransferObject2, childTransferObject3))
				.build();
	...
	void testBoundOperationInheritanceIsValid() throws Exception {
		...
		UnmappedTransferObjectType child = newUnmappedTransferObjectTypeBuilder().withName("child")
				.withSuperTransferObjectTypes(parent).build();

		BoundOperation operation1 = newBoundOperationBuilder().withName("operation1")
				.withInput(newParameterBuilder().withName("input").withType(child)
						.withCardinality(newCardinalityBuilder().build()))
				.withOutput(newParameterBuilder().withName("output").withType(parent)
						.withCardinality(newCardinalityBuilder().build()))
				.build();

		BoundOperation operation2 = newBoundOperationBuilder().withName("operation1")
				.withInput(newParameterBuilder().withName("input").withType(parent)
						.withCardinality(newCardinalityBuilder().build()))
				.withOutput(newParameterBuilder().withName("output").withType(child)
						.withCardinality(newCardinalityBuilder().build()))
				.build();
		...
		MappedTransferObjectType parentTransferObject1 = newMappedTransferObjectTypeBuilder()
				.withName("parentTransferObject1").withEntityType(parentEntityType1)
		...
		MappedTransferObjectType parentTransferObject2 = newMappedTransferObjectTypeBuilder()
				.withName("parentTransferObject2").withEntityType(parentEntityType2).withOperations(operation2).build();

		EntityType childEntityType1 = newEntityTypeBuilder().withName("childEntityType")
				.withSuperEntityTypes(parentEntityType2).build();
		MappedTransferObjectType childTransferObject = newMappedTransferObjectTypeBuilder()
				.withName("childTransferObject").withEntityType(childEntityType1)
				.withSuperTransferObjectTypes(parentTransferObject2).withOperations(operation4).build();

		EntityType childEntityType2 = newEntityTypeBuilder().withName("childEntityType2")
				.withSuperEntityTypes(ImmutableList.of(parentEntityType1, childEntityType1)).build();
		MappedTransferObjectType grandChildTransferObject = newMappedTransferObjectTypeBuilder()
				.withName("grandChildTransferObject").withEntityType(childEntityType2)
				.withSuperTransferObjectTypes(ImmutableList.of(parentTransferObject1, childTransferObject)).build();

		Model model = newModelBuilder().withName("M")
				.withElements(ImmutableList.of(parent, child, parentEntityType1, parentEntityType2, childEntityType1,
						childEntityType2, parentTransferObject1, parentTransferObject2, childTransferObject,
						grandChildTransferObject))
				.build();
	...
	void testUnmappedTransferObjectTypeHasNoAttributeBinding() throws Exception {
		...
		StaticData d = newStaticDataBuilder().withName("D").withDataType(string)
	...
	void testDataTypeMatchesBindingDataType() throws Exception {
		...
		DataProperty property0 = newDataPropertyBuilder().withName("property0").withDataType(integerType)
				.withGetterExpression(newDataExpressionTypeBuilder().withExpression("self.attribute0").build()).build();
		DataProperty property1 = newDataPropertyBuilder().withName("property1").withDataType(stringType)
		...
		EntityType entity = newEntityTypeBuilder().withName("entity")
				...
				.withDataProperties(ImmutableList.of(property0, property1)).build();

		TransferAttribute transferAttribute0 = newTransferAttributeBuilder().withName("TransferAttribute0")
				.withDataType(integerType).withBinding(attribute0).build();
		TransferAttribute transferAttribute1 = newTransferAttributeBuilder().withName("TransferAttribute1")
				.withDataType(integerType).withBinding(attribute1).build();
		TransferAttribute transferAttribute2 = newTransferAttributeBuilder().withName("TransferAttribute2")
				.withDataType(integerType).withBinding(property0).build();
		TransferAttribute transferAttribute3 = newTransferAttributeBuilder().withName("TransferAttribute3")
				.withDataType(integerType).withBinding(property1).build();
		TransferAttribute transferAttribute4 = newTransferAttributeBuilder().withName("TransferAttribute4")
				.withDataType(integerType).withBinding(staticData0).build();
		TransferAttribute transferAttribute5 = newTransferAttributeBuilder().withName("TransferAttribute5")
				.withDataType(integerType).withBinding(staticData1).build();

		MappedTransferObjectType transferObject = newMappedTransferObjectTypeBuilder()
				.withName("TransferObject").withAttributes(ImmutableList.of(transferAttribute0, transferAttribute1,
						transferAttribute2, transferAttribute3, transferAttribute4, transferAttribute5))
				.withEntityType(entity).build();

		Model model = newModelBuilder().withName("M")
				.withElements(
						ImmutableList.of(integerType, stringType, entity, transferObject, staticData0, staticData1))
				.build();
	...
	void testRequiredFlagMatchesBindingRequiredFlag() throws Exception {
		...
		Attribute attribute0 = newAttributeBuilder().withName("attribute0").withDataType(integerType)
				.withRequired(false).build();
		Attribute attribute1 = newAttributeBuilder().withName("attribute1").withDataType(integerType).withRequired(true)
				.build();

		DataProperty property0 = newDataPropertyBuilder().withName("property0").withDataType(integerType)
				.withGetterExpression(newDataExpressionTypeBuilder().withExpression("self.attribute0").build())
				.withRequired(false).build();
		DataProperty property1 = newDataPropertyBuilder().withName("property1").withDataType(integerType)
				.withGetterExpression(newDataExpressionTypeBuilder().withExpression("self.attribute1").build())
				.withRequired(true).build();

		StaticData staticData0 = newStaticDataBuilder().withName("staticData0").withDataType(integerType)
				.withGetterExpression(newDataExpressionTypeBuilder().withExpression("1").build()).withRequired(false)
				.build();
		StaticData staticData1 = newStaticDataBuilder().withName("staticData1").withDataType(integerType)
				.withGetterExpression(newDataExpressionTypeBuilder().withExpression("1").build()).withRequired(true)
				.build();
		...
		TransferAttribute transferAttribute0 = newTransferAttributeBuilder().withName("TransferAttribute0")
				.withDataType(integerType).withBinding(attribute0).withRequired(true).build();
		TransferAttribute transferAttribute1 = newTransferAttributeBuilder().withName("TransferAttribute1")
				.withDataType(integerType).withBinding(attribute1).withRequired(true).build();
		TransferAttribute transferAttribute2 = newTransferAttributeBuilder().withName("TransferAttribute2")
				.withDataType(integerType).withBinding(property0).withRequired(true).build();
		TransferAttribute transferAttribute3 = newTransferAttributeBuilder().withName("TransferAttribute3")
				.withDataType(integerType).withBinding(property1).withRequired(true).build();
		TransferAttribute transferAttribute4 = newTransferAttributeBuilder().withName("TransferAttribute4")
				.withDataType(integerType).withBinding(staticData0).withRequired(true).build();
		TransferAttribute transferAttribute5 = newTransferAttributeBuilder().withName("TransferAttribute5")
				.withDataType(integerType).withBinding(staticData1).withRequired(true).build();
		...
		Model model = newModelBuilder().withName("M")
				.withElements(ImmutableList.of(entity, transferObject, staticData0, staticData1)).build();
	...
	void testTransferAttributeBindingIsValid() throws Exception {
		...
		DataProperty property0 = newDataPropertyBuilder().withName("property0").withDataType(integer)
				.withGetterExpression(newDataExpressionTypeBuilder().withExpression("self.attribute0").build()).build();
		DataProperty property1 = newDataPropertyBuilder().withName("property1").withDataType(integer)
				.withGetterExpression(newDataExpressionTypeBuilder().withExpression("self.attribute1").build()).build();
		DataProperty property2 = newDataPropertyBuilder().withName("property2").withDataType(integer)
		...
		EntityType parent = newEntityTypeBuilder().withName("parent").withAttributes(attribute0)
				.withDataProperties(property0).build();
		EntityType child = newEntityTypeBuilder().withName("child").withSuperEntityTypes(parent)
				.withAttributes(attribute1).withDataProperties(property1).build();
		EntityType friend = newEntityTypeBuilder().withName("friend").withAttributes(attribute2)
				.withDataProperties(property2).build();

		TransferAttribute transferAttribute0 = newTransferAttributeBuilder().withName("TransferAttribute0")
				.withDataType(integer).withBinding(attribute0).build();
		TransferAttribute transferAttribute1 = newTransferAttributeBuilder().withName("TransferAttribute1")
		...
		MappedTransferObjectType transferObject = newMappedTransferObjectTypeBuilder().withName("TransferObject")
				.withAttributes(ImmutableList.of(transferAttribute0, transferAttribute1, transferAttribute2,
						transferAttribute3, transferAttribute4, transferAttribute5, transferAttribute6))
				.withEntityType(child).build();

		Model model = newModelBuilder().withName("M")
				.withElements(ImmutableList.of(integer, parent, child, friend, transferObject, staticData)).build();
	...
	void testUnmappedTransferObjectTypeHasNoRelationBinding() throws Exception {
		...
		StaticNavigation n = newStaticNavigationBuilder().withName("N").withCardinality(newCardinalityBuilder().build())
				.build();
		TransferObjectRelation r = newTransferObjectRelationBuilder().withName("R").withBinding(n)
				.withCardinality(newCardinalityBuilder().build()).build();
	...
	void testTargetMatchesBindingTarget() throws Exception {
		...
		AssociationEnd e0 = newAssociationEndBuilder().withName("e0").withCardinality(newCardinalityBuilder().build())
				.build();
		...
		NavigationProperty n0 = newNavigationPropertyBuilder().withName("n0")
				.withCardinality(newCardinalityBuilder().build())
				.withGetterExpression(newReferenceExpressionTypeBuilder().withExpression("self.e0").build()).build();
		NavigationProperty n1 = newNavigationPropertyBuilder().withName("n1")
				.withCardinality(newCardinalityBuilder().build())
				.withGetterExpression(newReferenceExpressionTypeBuilder().withExpression("self.e1").build()).build();
		NavigationProperty n2 = newNavigationPropertyBuilder().withName("n2")
				.withCardinality(newCardinalityBuilder().build())
		...
		StaticNavigation staticNav1 = newStaticNavigationBuilder().withName("staticNav1")
				.withCardinality(newCardinalityBuilder().build())
				.withGetterExpression(newReferenceExpressionTypeBuilder().withExpression("targetChild").build())
				.build();
		StaticNavigation staticNav2 = newStaticNavigationBuilder().withName("staticNav2")
				.withCardinality(newCardinalityBuilder().build())
				.withGetterExpression(newReferenceExpressionTypeBuilder().withExpression("friend").build()).build();

		EntityType parent = newEntityTypeBuilder().withName("parent").withRelations(e0).withNavigationProperties(n0)
				.build();
		EntityType child = newEntityTypeBuilder().withName("child").withSuperEntityTypes(parent)
				.withRelations(ImmutableList.of(e1, e2)).withNavigationProperties(ImmutableList.of(n1, n2)).build();

		EntityType targetParent = newEntityTypeBuilder().withName("targetParent").build();
		EntityType targetChild = newEntityTypeBuilder().withName("targetChild").withSuperEntityTypes(targetParent)
				.build();
		...
		MappedTransferObjectType targetTransferObject = newMappedTransferObjectTypeBuilder()
				.withName("TargetTransferObject").withEntityType(targetChild).build();

		TransferObjectRelation transferRelation0 = newTransferObjectRelationBuilder().withName("TransferRelation0")
				.withBinding(e0).withTarget(targetTransferObject).withCardinality(newCardinalityBuilder().build())
				.build();
		TransferObjectRelation transferRelation1 = newTransferObjectRelationBuilder().withName("TransferRelation1")
				.withBinding(e1).withTarget(targetTransferObject).withCardinality(newCardinalityBuilder().build())
				.build();
		TransferObjectRelation transferRelation2 = newTransferObjectRelationBuilder().withName("TransferRelation2")
				.withBinding(e2).withTarget(targetTransferObject).withCardinality(newCardinalityBuilder().build())
				.build();
		TransferObjectRelation transferRelation3 = newTransferObjectRelationBuilder().withName("TransferRelation3")
				.withBinding(n0).withTarget(targetTransferObject).withCardinality(newCardinalityBuilder().build())
				.build();
		TransferObjectRelation transferRelation4 = newTransferObjectRelationBuilder().withName("TransferRelation4")
				.withBinding(n1).withTarget(targetTransferObject).withCardinality(newCardinalityBuilder().build())
				.build();
		TransferObjectRelation transferRelation5 = newTransferObjectRelationBuilder().withName("TransferRelation5")
				.withBinding(n2).withTarget(targetTransferObject).withCardinality(newCardinalityBuilder().build())
				.build();
		TransferObjectRelation transferRelation6 = newTransferObjectRelationBuilder().withName("TransferRelation6")
				.withBinding(staticNav1).withTarget(targetTransferObject)
				.withCardinality(newCardinalityBuilder().build()).build();
		TransferObjectRelation transferRelation7 = newTransferObjectRelationBuilder().withName("TransferRelation7")
				.withBinding(staticNav2).withTarget(targetTransferObject)
				.withCardinality(newCardinalityBuilder().build()).build();

		MappedTransferObjectType transferObject = newMappedTransferObjectTypeBuilder().withName("TransferObject")
				.withRelations(ImmutableList.of(transferRelation0, transferRelation1, transferRelation2,
						transferRelation3, transferRelation4, transferRelation5, transferRelation6, transferRelation7))
				.withEntityType(child).build();

		Model model = newModelBuilder().withName("M").withElements(ImmutableList.of(parent, child, targetParent,
				targetChild, friend, transferObject, targetTransferObject, staticNav1, staticNav2)).build();
	...
	void testCardinalityMatchesBindingCardinality() throws Exception {
		...
		AssociationEnd end0 = newAssociationEndBuilder().withName("end0")
				.withCardinality(newCardinalityBuilder().withLower(0).withUpper(5).build()).build();
		TransferObjectRelation transferRelation0 = newTransferObjectRelationBuilder().withName("TransferRelation0")
		...
		Containment containment = newContainmentBuilder().withName("containment")
				.withCardinality(newCardinalityBuilder().withLower(2).withUpper(3).build()).build();
		TransferObjectRelation transferRelation2 = newTransferObjectRelationBuilder().withName("TransferRelation2")
		...
		StaticNavigation staticNav0 = newStaticNavigationBuilder().withName("staticNav0")
				.withCardinality(newCardinalityBuilder().withLower(2).withUpper(3).build())
				.withGetterExpression(newReferenceExpressionTypeBuilder().withExpression("entity").build()).build();
		TransferObjectRelation transferRelation4 = newTransferObjectRelationBuilder().withName("TransferRelation4")
		...
		EntityType entity = newEntityTypeBuilder().withName("entity")
				.withRelations(ImmutableList.of(end0, end1, containment)).withNavigationProperties(navigation).build();

		MappedTransferObjectType transferObject = newMappedTransferObjectTypeBuilder()
				.withName("TransferObject").withRelations(ImmutableList.of(transferRelation0, transferRelation1,
						transferRelation2, transferRelation3, transferRelation4, transferRelation5))
				.withEntityType(entity).build();

		Model model = newModelBuilder().withName("M")
				.withElements(ImmutableList.of(entity, transferObject, staticNav0, staticNav1)).build();
	...
	void testTransferObjectRelationIsEmbedded() throws Exception {
		...
		TransferObjectRelation r = newTransferObjectRelationBuilder().withName("R")
				.withCardinality(newCardinalityBuilder().build()).build();
		...
		runEpsilon(ImmutableList.of(
				"TransferObjectRelationIsEmbedded|Transfer object relation R is referencing to unembedded unmapped transfer object type: O"),
				Collections.emptyList());
	}
	...
	void testTransferObjectRelationBindingIsValid() throws Exception {
		...
		AssociationEnd e0 = newAssociationEndBuilder().withName("e1").withCardinality(newCardinalityBuilder().build())
				.build();
		AssociationEnd e1 = newAssociationEndBuilder().withName("e2").withCardinality(newCardinalityBuilder().build())
				.build();
		AssociationEnd e2 = newAssociationEndBuilder().withName("e3").withCardinality(newCardinalityBuilder().build())
				.build();
		...
		StaticNavigation staticNav = newStaticNavigationBuilder().withName("staticNav")
				.withCardinality(newCardinalityBuilder().build())
				.withGetterExpression(newReferenceExpressionTypeBuilder().withExpression("child").build()).build();

		EntityType parent = newEntityTypeBuilder().withName("parent").withRelations(e0).withNavigationProperties(n0)
				.build();
		EntityType child = newEntityTypeBuilder().withName("child").withSuperEntityTypes(parent).withRelations(e1)
				.withNavigationProperties(n1).build();
		EntityType friend = newEntityTypeBuilder().withName("friend").withRelations(e2).withNavigationProperties(n2)
				.build();
		...
		TransferObjectRelation transferRelation0 = newTransferObjectRelationBuilder().withName("TransferRelation0")
				.withCardinality(newCardinalityBuilder().build()).withBinding(e0).build();
		TransferObjectRelation transferRelation1 = newTransferObjectRelationBuilder().withName("TransferRelation1")
				.withBinding(e1).withCardinality(newCardinalityBuilder().build()).build();
		TransferObjectRelation transferRelation2 = newTransferObjectRelationBuilder().withName("TransferRelation2")
				.withCardinality(newCardinalityBuilder().build()).withBinding(e2).build();
		TransferObjectRelation transferRelation3 = newTransferObjectRelationBuilder().withName("TransferRelation3")
				.withCardinality(newCardinalityBuilder().build()).withBinding(n0).build();
		TransferObjectRelation transferRelation4 = newTransferObjectRelationBuilder().withName("TransferRelation4")
				.withCardinality(newCardinalityBuilder().build()).withBinding(n1).build();
		TransferObjectRelation transferRelation5 = newTransferObjectRelationBuilder().withName("TransferRelation5")
				.withCardinality(newCardinalityBuilder().build()).withBinding(n2).build();
		TransferObjectRelation transferRelation6 = newTransferObjectRelationBuilder().withName("TransferRelation6")
				.withCardinality(newCardinalityBuilder().build()).withBinding(staticNav).build();

		MappedTransferObjectType transferObject = newMappedTransferObjectTypeBuilder().withName("TransferObject")
				.withRelations(ImmutableList.of(transferRelation0, transferRelation1, transferRelation2,
						transferRelation3, transferRelation4, transferRelation5, transferRelation6))
				.withEntityType(child).build();

		Model model = newModelBuilder().withName("M")
				.withElements(ImmutableList.of(parent, child, friend, transferObject, staticNav)).build();
	...
	void testTransferObjectTypeNamesAreUnique() throws Exception {
		...
		MappedTransferObjectType transferObject1 = newMappedTransferObjectTypeBuilder().withName("TransferObject")
				.build();
		UnmappedTransferObjectType transferObject2 = newUnmappedTransferObjectTypeBuilder().withName("transferObject")
				.build();
	...
	void testUnboundOperationNamesAreUnique() throws Exception {
		...
		UnboundOperation unboundOp1 = newUnboundOperationBuilder().withName("unboundoperation")
				.withImplementation(newOperationBodyBuilder().withBody("body").build()).build();
	...
	void testUnmappedTransferObjectTypeHasNoMappedSuperTransferObjectType() throws Exception {
		...
		UnmappedTransferObjectType unmappedParent1 = newUnmappedTransferObjectTypeBuilder().withName("unmappedParent1")
				.build();
		UnmappedTransferObjectType unmappedParent2 = newUnmappedTransferObjectTypeBuilder().withName("unmappedParent2")
				.withSuperTransferObjectTypes(unmappedParent1).build();

		EntityType entityType1 = newEntityTypeBuilder().withName("entityType1").build();
		MappedTransferObjectType mappedParent1 = newMappedTransferObjectTypeBuilder().withName("mappedParent1")
				.withEntityType(entityType1).withSuperTransferObjectTypes(unmappedParent2).build();

		EntityType entityType2 = newEntityTypeBuilder().withName("entityType2").build();
		MappedTransferObjectType mappedParent2 = newMappedTransferObjectTypeBuilder().withName("mappedParent")
				.withEntityType(entityType2).withSuperTransferObjectTypes(unmappedParent1).build();

		UnmappedTransferObjectType unmappedChild = newUnmappedTransferObjectTypeBuilder().withName("unmappedChild")
				.withSuperTransferObjectTypes(mappedParent2).build();

		Model model = newModelBuilder().withName("M").withElements(ImmutableList.of(unmappedParent1, unmappedParent2,
				entityType1, entityType2, mappedParent1, mappedParent2, unmappedChild)).build();
	...
	void testInheritedAndOwnTransferAttributeNameIsUniqueInTransferObjectType() throws Exception {
		...
		TransferObjectRelation relation = newTransferObjectRelationBuilder().withName("element").withTarget(target)
				.withCardinality(newCardinalityBuilder().withLower(0).withUpper(1).build()).withEmbedded(true).build();
		...
		TransferAttribute wrongAttribute1 = newTransferAttributeBuilder().withName("element").withDataType(string)
				.build();
		...
		MappedTransferObjectType child1 = newMappedTransferObjectTypeBuilder().withName("child1")
				.withEntityType(entityType1).withSuperTransferObjectTypes(ImmutableList.of(parent1, parent2))
				.withAttributes(ImmutableList.of(wrongAttribute1, wrongAttribute2)).build();

		TransferAttribute correctAttribute = newTransferAttributeBuilder().withName("own").withDataType(string).build();
		EntityType entityType2 = newEntityTypeBuilder().withName("entityType2").build();
		MappedTransferObjectType child2 = newMappedTransferObjectTypeBuilder().withName("child")
				.withEntityType(entityType2).withSuperTransferObjectTypes(ImmutableList.of(parent1, parent2))
				.withAttributes(correctAttribute).build();

		Model model = newModelBuilder().withName("M")
				.withElements(
						ImmutableList.of(string, target, parent1, parent2, entityType1, child1, entityType2, child2))
				.build();

		psmModel.addContent(model);

		runEpsilon(ImmutableList.of("InheritedAndOwnTransferAttributeNameIsUniqueInTransferObjectType|"
	...
	void testInheritedAndOwnTransferObjectRelationNameIsUniqueInTransferObjectType() throws Exception {
		...
		UnmappedTransferObjectType parent1 = newUnmappedTransferObjectTypeBuilder().withName("parent1")
				.withAttributes(attribute).build();
		UnmappedTransferObjectType parent2 = newUnmappedTransferObjectTypeBuilder().withName("parent2")
		...
		TransferObjectRelation wrongRelation1 = newTransferObjectRelationBuilder().withName("element")
				.withTarget(target21).withCardinality(newCardinalityBuilder().withLower(0).withUpper(1).build())
		...
		MappedTransferObjectType child1 = newMappedTransferObjectTypeBuilder().withName("child1")
				.withEntityType(entityType1).withSuperTransferObjectTypes(ImmutableList.of(parent1, parent2))
				.withRelations(ImmutableList.of(wrongRelation1, wrongRelation2)).build();
		...
		MappedTransferObjectType child2 = newMappedTransferObjectTypeBuilder().withName("child2")
				.withEntityType(entityType2).withSuperTransferObjectTypes(ImmutableList.of(parent1, parent2))
				.withRelations(correctRelation).build();

		Model model = newModelBuilder().withName("M").withElements(ImmutableList.of(string, target11, target12,
				target21, target22, target3, parent1, parent2, entityType1, entityType2, child1, child2)).build();

		psmModel.addContent(model);

		runEpsilon(ImmutableList.of("InheritedAndOwnTransferObjectRelationNameIsUniqueInTransferObjectType|"
	...
	void testInheritingUniqueAttributeNamesLowerCase() throws Exception {
		...
		EntityType entityType1 = newEntityTypeBuilder().withName("entityType1").build();
		MappedTransferObjectType mappedParent1 = newMappedTransferObjectTypeBuilder().withName("mappedParent1")
				.withEntityType(entityType1).withAttributes(attribute1).build();

		EntityType entityType2 = newEntityTypeBuilder().withName("entityType2").withSuperEntityTypes(entityType1)
				.build();
		MappedTransferObjectType mappedParent2 = newMappedTransferObjectTypeBuilder().withName("mappedParent2")
				.withEntityType(entityType2).withSuperTransferObjectTypes(mappedParent1).build();

		UnmappedTransferObjectType parent = newUnmappedTransferObjectTypeBuilder().withName("unmapped")
				.withAttributes(attribute2).build();

		EntityType entityType3 = newEntityTypeBuilder().withName("entityType3").withSuperEntityTypes(entityType2)
				.build();
		MappedTransferObjectType child = newMappedTransferObjectTypeBuilder().withName("child")
				.withEntityType(entityType3).withSuperTransferObjectTypes(ImmutableList.of(mappedParent2, parent))
				.build();

		Model model = newModelBuilder().withName("M").withElements(ImmutableList.of(string, entityType1, entityType2,
				entityType3, mappedParent1, mappedParent2, parent, child)).build();
	...
	void testInheritingUniqueRelationNamesLowerCase() throws Exception {
		...
		EntityType entityType1 = newEntityTypeBuilder().withName("entityType1").build();
		MappedTransferObjectType mappedParent1 = newMappedTransferObjectTypeBuilder().withName("mappedParent1")
				.withEntityType(entityType1).withRelations(relation1).build();
	...
	void testInheritingAttributesAndRelationsOfTheSameNameIsNotAllowedLowerCase() throws Exception {
		...
		EntityType entityType2 = newEntityTypeBuilder().withName("entityType2").withSuperEntityTypes(entityType1)
				.build();
		MappedTransferObjectType mappedParent2 = newMappedTransferObjectTypeBuilder().withName("mappedParent2")
				.withEntityType(entityType2).withSuperTransferObjectTypes(mappedParent1).withAttributes(attribute2)
				.build();
	...
	void testInheritedOperationAndTransferAttributeNamesAreUniqueLowerCase() throws Exception {
		...
		EntityType entityType1 = newEntityTypeBuilder().withName("entityType1").build();
		MappedTransferObjectType mappedParent1 = newMappedTransferObjectTypeBuilder().withName("mappedParent1")
				.withEntityType(entityType1).withOperations(operation).build();
		...
		Model model = newModelBuilder().withName("M").withElements(ImmutableList.of(string, type, entityType1,
				entityType2, entityType3, mappedParent1, mappedParent2, parent, child)).build();

		psmModel.addContent(model);

		runEpsilon(ImmutableList.of("InheritedOperationAndTransferAttributeNamesAreUnique|"
	...
	void testInheritedOperationAndTransferObjectRelationNamesAreUniqueLowerCase() throws Exception {
		...
		Model model = newModelBuilder().withName("M").withElements(ImmutableList.of(type, entityType1, entityType2,
				entityType3, mappedParent1, mappedParent2, parent, child)).build();

		psmModel.addContent(model);

		runEpsilon(ImmutableList.of("InheritedOperationAndTransferObjectRelationNamesAreUnique|"
	...
	void testInheritedOperationAndTransferObjectRelationNamesAreUniqueMixedCase() throws Exception {
		...
		Model model = newModelBuilder().withName("M").withElements(ImmutableList.of(type, target, entityType1,
				entityType2, entityType3, mappedParent1, mappedParent2, parent, child)).build();
	...
	void testCardinalityLowerIsGreaterThanOrEqualToZero() throws Exception {
		...
		runEpsilon(
				ImmutableList.of("CardinalityLowerIsGreaterThanOrEqualToZero|"
						+ "Lower attribute of: relation must be greater than or equal to zero"),
				Collections.emptyList());
	}
	...
	void testCardinalityLowerMustBeLessOrEqualToUpper() throws Exception {
		...
		runEpsilon(ImmutableList.of(
				"CardinalityLowerMustBeLessOrEqualToUpper|Lower (3) must be less or equal to upper (1) of attribute: relation"),
				Collections.emptyList());
	}
	...
	void testCardinalityUpperIsAtLeastOne() throws Exception {
		...
		runEpsilon(ImmutableList.of("CardinalityUpperIsAtLeastOne|Invalid upper attribute of relation",
				"CardinalityLowerMustBeLessOrEqualToUpper|Lower (3) must be less or equal to upper (0) of attribute: relation"),
				Collections.emptyList());
	}
}
