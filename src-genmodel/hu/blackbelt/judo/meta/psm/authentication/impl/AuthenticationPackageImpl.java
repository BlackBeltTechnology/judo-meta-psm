...
import hu.blackbelt.judo.meta.psm.authentication.AuthenticationFactory;
...
public class AuthenticationPackageImpl extends EPackageImpl implements AuthenticationPackage {
	 ...
	 * @generated
	 */
	private EClass passwordAuthenticatedUserEClass = null;
	 ...
	 * @generated
	 */
	private EClass authenticatedUserEClass = null;
	 ...
	 * @see hu.blackbelt.judo.meta.psm.authentication.AuthenticationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static AuthenticationPackage init() {
		...
		AuthenticationPackageImpl theAuthenticationPackage = (AuthenticationPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AuthenticationPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AuthenticationPackageImpl());
	 ...
	 * @generated
	 */
	public EClass getPasswordAuthenticatedUser() {
		return passwordAuthenticatedUserEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getPasswordAuthenticatedUser_Password() {
		return (EReference)passwordAuthenticatedUserEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getPasswordAuthenticatedUser_Login() {
		return (EReference)passwordAuthenticatedUserEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getAuthenticatedUser() {
		return authenticatedUserEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getAuthenticatedUser_User() {
		return (EReference)authenticatedUserEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		passwordAuthenticatedUserEClass = createEClass(PASSWORD_AUTHENTICATED_USER);
		createEReference(passwordAuthenticatedUserEClass, PASSWORD_AUTHENTICATED_USER__PASSWORD);
		createEReference(passwordAuthenticatedUserEClass, PASSWORD_AUTHENTICATED_USER__LOGIN);

		authenticatedUserEClass = createEClass(AUTHENTICATED_USER);
		createEReference(authenticatedUserEClass, AUTHENTICATED_USER__USER);
	}
	...
	public void initializePackageContents() {
		...
		passwordAuthenticatedUserEClass.getESuperTypes().add(this.getAuthenticatedUser());

		// Initialize classes, features, and operations; add parameters
		initEClass(passwordAuthenticatedUserEClass, PasswordAuthenticatedUser.class, "PasswordAuthenticatedUser", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPasswordAuthenticatedUser_Password(), theDataPackage.getAttribute(), null, "password", null, 1, 1, PasswordAuthenticatedUser.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPasswordAuthenticatedUser_Login(), theDataPackage.getAttribute(), null, "login", null, 1, 1, PasswordAuthenticatedUser.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(authenticatedUserEClass, AuthenticatedUser.class, "AuthenticatedUser", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAuthenticatedUser_User(), theDataPackage.getEntityType(), null, "user", null, 1, 1, AuthenticatedUser.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
