...
public class AuthorizationAdapterFactory extends AdapterFactoryImpl {
    ...
    protected AuthorizationSwitch<Adapter> modelSwitch =
        new AuthorizationSwitch<Adapter>() {
            @Override
            public Adapter caseAuthorizationResource(AuthorizationResource object) {
                return createAuthorizationResourceAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.psm.authorization.AuthorizationResource <em>Resource</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createAuthorizationResourceAdapter() {
        return null;
    }
