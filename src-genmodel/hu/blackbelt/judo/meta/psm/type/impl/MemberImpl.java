 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.psm.type.impl.MemberImpl#getOrdinal <em>Ordinal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemberImpl extends NamedElementImpl implements Member {
    ...
    protected EClass eStaticClass() {
        return TypePackage.Literals.MEMBER;
    }
    ...
    public void setOrdinal(int newOrdinal) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TypePackage.MEMBER__ORDINAL, oldOrdinal, ordinal));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case TypePackage.MEMBER__ORDINAL:
                return getOrdinal();
        }
