...
public class TypePackageImpl extends EPackageImpl implements TypePackage {
    ...
    public void initializePackageContents() {
        ...
        fieldEClass.getESuperTypes().add(theNamespacePackage.getNamedElement());
        ...
        initEReference(getStructure_Fields(), this.getField(), null, "fields", null, 1, -1, Structure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getField_Required(), ecorePackage.getEBoolean(), "required", null, 1, 1, Field.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
