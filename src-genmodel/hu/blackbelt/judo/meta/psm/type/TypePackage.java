...
public interface TypePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int CUSTOM_TYPE_OPERATION_COUNT = FLAT_PRIMITIVE_TYPE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int STRING_TYPE_OPERATION_COUNT = FLAT_PRIMITIVE_TYPE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int NUMERIC_TYPE_OPERATION_COUNT = FLAT_PRIMITIVE_TYPE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int BOOLEAN_TYPE_OPERATION_COUNT = FLAT_PRIMITIVE_TYPE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int XML_TYPE_OPERATION_COUNT = FLAT_PRIMITIVE_TYPE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int PASSWORD_TYPE_OPERATION_COUNT = FLAT_PRIMITIVE_TYPE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int DATE_TYPE_OPERATION_COUNT = FLAT_PRIMITIVE_TYPE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TIMESTAMP_TYPE_FEATURE_COUNT = FLAT_PRIMITIVE_TYPE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TIMESTAMP_TYPE_OPERATION_COUNT = FLAT_PRIMITIVE_TYPE_OPERATION_COUNT + 0;
