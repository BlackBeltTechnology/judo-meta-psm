...
public class BehaviorAdapterFactory extends AdapterFactoryImpl {
    ...
    protected BehaviorSwitch<Adapter> modelSwitch =
        new BehaviorSwitch<Adapter>() {
            @Override
            public Adapter caseCascadeReferences(CascadeReferences object) {
                return createCascadeReferencesAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link hu.blackbelt.judo.meta.psm.behavior.CascadeReferences <em>Cascade References</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createCascadeReferencesAdapter() {
        return null;
    }
