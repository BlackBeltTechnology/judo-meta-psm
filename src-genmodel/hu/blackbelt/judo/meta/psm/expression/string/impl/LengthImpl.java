 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.psm.expression.string.impl.LengthImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LengthImpl extends MinimalEObjectImpl.Container implements Length {
	...
	protected EClass eStaticClass() {
		return StringPackage.Literals.LENGTH;
	}
	...
	public NotificationChain basicSetExpression(StringExpression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StringPackage.LENGTH__EXPRESSION, oldExpression, newExpression);
	...
	public void setExpression(StringExpression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StringPackage.LENGTH__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StringPackage.LENGTH__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StringPackage.LENGTH__EXPRESSION, newExpression, newExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StringPackage.LENGTH__EXPRESSION:
