...
public interface StringPackage extends EPackage {
    ...
    /**
     * The meta object id for the '{@link hu.blackbelt.judo.meta.psm.expression.string.impl.StringVariableReferenceImpl <em>Variable Reference</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see hu.blackbelt.judo.meta.psm.expression.string.impl.StringVariableReferenceImpl
     * @see hu.blackbelt.judo.meta.psm.expression.string.impl.StringPackageImpl#getStringVariableReference()
     * @generated
     */
    ...
    /**
     * Returns the meta object for class '{@link hu.blackbelt.judo.meta.psm.expression.string.StringVariableReference <em>Variable Reference</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for class '<em>Variable Reference</em>'.
     * @see hu.blackbelt.judo.meta.psm.expression.string.StringVariableReference
     * @generated
     */
    EClass getStringVariableReference();

    /**
     * Returns the meta object for the reference '{@link hu.blackbelt.judo.meta.psm.expression.string.StringVariableReference#getVariable <em>Variable</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the reference '<em>Variable</em>'.
     * @see hu.blackbelt.judo.meta.psm.expression.string.StringVariableReference#getVariable()
    ...
    interface Literals {
        ...
        /**
         * The meta object literal for the '{@link hu.blackbelt.judo.meta.psm.expression.string.impl.StringVariableReferenceImpl <em>Variable Reference</em>}' class.
         * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
         * @see hu.blackbelt.judo.meta.psm.expression.string.impl.StringVariableReferenceImpl
         * @see hu.blackbelt.judo.meta.psm.expression.string.impl.StringPackageImpl#getStringVariableReference()
