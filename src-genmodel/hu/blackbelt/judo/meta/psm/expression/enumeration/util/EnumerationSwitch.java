...
public class EnumerationSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case EnumerationPackage.ENUMERATION_ATTRIBUTE: {
                EnumerationAttribute enumerationAttribute = (EnumerationAttribute)theEObject;
                T result = caseEnumerationAttribute(enumerationAttribute);
                if (result == null) result = caseEnumerationExpression(enumerationAttribute);
                if (result == null) result = caseAttributeSelector(enumerationAttribute);
                if (result == null) result = caseDataExpression(enumerationAttribute);
                if (result == null) result = caseExpression(enumerationAttribute);
            ...
            case EnumerationPackage.ENUMERATION_SWITCH_EXPRESSION: {
                ...
                if (result == null) result = caseSwitchExpression(enumerationSwitchExpression);
                if (result == null) result = caseEnumerationExpression(enumerationSwitchExpression);
                if (result == null) result = caseDataExpression(enumerationSwitchExpression);
                if (result == null) result = caseExpression(enumerationSwitchExpression);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
     ...
     * @generated
     */
    public T caseEnumerationSwitchExpression(EnumerationSwitchExpression object) {
        return null;
    }
