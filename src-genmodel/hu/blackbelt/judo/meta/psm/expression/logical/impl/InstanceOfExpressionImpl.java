 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.psm.expression.logical.impl.InstanceOfExpressionImpl#getObjectExpression <em>Object Expression</em>}</li>
 *   <li>{@link hu.blackbelt.judo.meta.psm.expression.logical.impl.InstanceOfExpressionImpl#getElementName <em>Element Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstanceOfExpressionImpl extends MinimalEObjectImpl.Container implements InstanceOfExpression {
	...
	protected EClass eStaticClass() {
		return LogicalPackage.Literals.INSTANCE_OF_EXPRESSION;
	}
	...
	public NotificationChain basicSetObjectExpression(ObjectExpression newObjectExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LogicalPackage.INSTANCE_OF_EXPRESSION__OBJECT_EXPRESSION, oldObjectExpression, newObjectExpression);
	...
	public void setObjectExpression(ObjectExpression newObjectExpression) {
		if (newObjectExpression != objectExpression) {
			...
			if (objectExpression != null)
				msgs = ((InternalEObject)objectExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LogicalPackage.INSTANCE_OF_EXPRESSION__OBJECT_EXPRESSION, null, msgs);
			if (newObjectExpression != null)
				msgs = ((InternalEObject)newObjectExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LogicalPackage.INSTANCE_OF_EXPRESSION__OBJECT_EXPRESSION, null, msgs);
			msgs = basicSetObjectExpression(newObjectExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogicalPackage.INSTANCE_OF_EXPRESSION__OBJECT_EXPRESSION, newObjectExpression, newObjectExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LogicalPackage.INSTANCE_OF_EXPRESSION__OBJECT_EXPRESSION:
