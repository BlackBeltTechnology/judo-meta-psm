...
public class CustomFactoryImpl extends EFactoryImpl implements CustomFactory {
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            ...
            case CustomPackage.CUSTOM_VARIABLE_REFERENCE: return createCustomVariableReference();
     ...
     * @generated
     */
    public CustomVariableReference createCustomVariableReference() {
        CustomVariableReferenceImpl customVariableReference = new CustomVariableReferenceImpl();
        return customVariableReference;
    }
