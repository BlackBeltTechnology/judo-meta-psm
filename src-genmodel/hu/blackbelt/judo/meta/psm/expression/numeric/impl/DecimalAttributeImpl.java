 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.psm.expression.numeric.impl.DecimalAttributeImpl#getObjectExpression <em>Object Expression</em>}</li>
 *   <li>{@link hu.blackbelt.judo.meta.psm.expression.numeric.impl.DecimalAttributeImpl#getAttributeName <em>Attribute Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DecimalAttributeImpl extends MinimalEObjectImpl.Container implements DecimalAttribute {
	/**
	...
	protected EClass eStaticClass() {
		return NumericPackage.Literals.DECIMAL_ATTRIBUTE;
	}
	...
	public NotificationChain basicSetObjectExpression(ObjectExpression newObjectExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, NumericPackage.DECIMAL_ATTRIBUTE__OBJECT_EXPRESSION, oldObjectExpression, newObjectExpression);
	...
	public void setObjectExpression(ObjectExpression newObjectExpression) {
		if (newObjectExpression != objectExpression) {
			...
			if (objectExpression != null)
				msgs = ((InternalEObject)objectExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - NumericPackage.DECIMAL_ATTRIBUTE__OBJECT_EXPRESSION, null, msgs);
			if (newObjectExpression != null)
				msgs = ((InternalEObject)newObjectExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - NumericPackage.DECIMAL_ATTRIBUTE__OBJECT_EXPRESSION, null, msgs);
			msgs = basicSetObjectExpression(newObjectExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NumericPackage.DECIMAL_ATTRIBUTE__OBJECT_EXPRESSION, newObjectExpression, newObjectExpression));
	}
	...
	public void setAttributeName(String newAttributeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NumericPackage.DECIMAL_ATTRIBUTE__ATTRIBUTE_NAME, oldAttributeName, attributeName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NumericPackage.DECIMAL_ATTRIBUTE__OBJECT_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case NumericPackage.DECIMAL_ATTRIBUTE__ATTRIBUTE_NAME:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AttributeSelector.class) {
			switch (derivedFeatureID) {
				case NumericPackage.DECIMAL_ATTRIBUTE__OBJECT_EXPRESSION: return ExpressionPackage.ATTRIBUTE_SELECTOR__OBJECT_EXPRESSION;
				case NumericPackage.DECIMAL_ATTRIBUTE__ATTRIBUTE_NAME: return ExpressionPackage.ATTRIBUTE_SELECTOR__ATTRIBUTE_NAME;
				default: return -1;
			}
		}
