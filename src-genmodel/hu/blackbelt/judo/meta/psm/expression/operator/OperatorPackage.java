...
public interface OperatorPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link hu.blackbelt.judo.meta.psm.expression.operator.TimestampDurationOperator <em>Timestamp Duration Operator</em>}' enum.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see hu.blackbelt.judo.meta.psm.expression.operator.TimestampDurationOperator
	 * @see hu.blackbelt.judo.meta.psm.expression.operator.impl.OperatorPackageImpl#getTimestampDurationOperator()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for enum '{@link hu.blackbelt.judo.meta.psm.expression.operator.TimestampDurationOperator <em>Timestamp Duration Operator</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link hu.blackbelt.judo.meta.psm.expression.operator.TimestampDurationOperator <em>Timestamp Duration Operator</em>}' enum.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see hu.blackbelt.judo.meta.psm.expression.operator.TimestampDurationOperator
		 * @see hu.blackbelt.judo.meta.psm.expression.operator.impl.OperatorPackageImpl#getTimestampDurationOperator()
