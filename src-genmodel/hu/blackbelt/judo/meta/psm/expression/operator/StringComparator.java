...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>String Comparator</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see hu.blackbelt.judo.meta.psm.expression.operator.OperatorPackage#getStringComparator()
 * @model
 * @generated
 */
public enum StringComparator implements Enumerator {
    /**
     ...
     * @ordered
     */
    public static final int MATCHES_VALUE = 6;

    /**
     * An array of all the '<em><b>String Comparator</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    private static final StringComparator[] VALUES_ARRAY =
    ...
    /**
     * A public read-only list of all the '<em><b>String Comparator</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    public static final List<StringComparator> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

    /**
     * Returns the '<em><b>String Comparator</b></em>' literal with the specified literal value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static StringComparator get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            StringComparator result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>String Comparator</b></em>' literal with the specified name.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param name the name.
     * @return the matching enumerator or <code>null</code>.
     * @generated
     */
    public static StringComparator getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            StringComparator result = VALUES_ARRAY[i];
    ...
    /**
     * Returns the '<em><b>String Comparator</b></em>' literal with the specified integer value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public static StringComparator get(int value) {
        switch (value) {
     ...
     * @generated
     */
    private StringComparator(int value, String name, String literal) {
        this.value = value;
        this.name = name;
