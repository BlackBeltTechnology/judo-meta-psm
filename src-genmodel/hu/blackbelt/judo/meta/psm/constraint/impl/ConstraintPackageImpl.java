...
public class ConstraintPackageImpl extends EPackageImpl implements ConstraintPackage {
     ...
     * @generated
     */
    public EReference getInvariantConstraint_Constrained() {
    ...
    public void createPackageContents() {
        ...
        createEReference(invariantConstraintEClass, INVARIANT_CONSTRAINT__CONSTRAINED);
    }
    ...
    public void initializePackageContents() {
        ...
        initEReference(getInvariantConstraint_Expression(), theExpressionPackage.getLogicalExpression(), null, "expression", null, 1, 1, InvariantConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getInvariantConstraint_Constrained(), theDataPackage.getEntityType(), null, "constrained", null, 1, 1, InvariantConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
