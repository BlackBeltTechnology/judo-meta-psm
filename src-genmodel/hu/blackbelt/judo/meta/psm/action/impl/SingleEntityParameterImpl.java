...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Single Entity Parameter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.psm.action.impl.SingleEntityParameterImpl#getOnGetDefault <em>On Get Default</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SingleEntityParameterImpl extends EntityParameterImpl implements SingleEntityParameter {
    /**
     ...
     * @generated
     */
    protected SingleEntityParameterImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ActionPackage.Literals.SINGLE_ENTITY_PARAMETER;
    }
    ...
    public void setOnGetDefault(String newOnGetDefault) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ActionPackage.SINGLE_ENTITY_PARAMETER__ON_GET_DEFAULT, oldOnGetDefault, onGetDefault));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ActionPackage.SINGLE_ENTITY_PARAMETER__ON_GET_DEFAULT:
