 ...
 *   <li>{@link hu.blackbelt.judo.meta.psm.facade.Link#isExpand <em>Expand</em>}</li>
 * </ul>
 *
...
public interface Link extends NamedElement {
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Expand</em>' attribute isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * @return the value of the '<em>Expand</em>' attribute.
     * @see #setExpand(boolean)
     * @see hu.blackbelt.judo.meta.psm.facade.FacadePackage#getLink_Expand()
     * @model
     * @generated
     */
    boolean isExpand();
    ...
    /**
     * Sets the value of the '{@link hu.blackbelt.judo.meta.psm.facade.Link#isExpand <em>Expand</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
