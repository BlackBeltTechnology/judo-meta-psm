 ...
 *   <li>{@link hu.blackbelt.judo.meta.psm.facade.impl.PropertyImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyImpl extends NamedElementImpl implements Property {
    ...
    public Type getType() {
        if (type != null && type.eIsProxy()) {
            ...
            if (type != oldType) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, FacadePackage.PROPERTY__TYPE, oldType, type));
            }
        }
        return type;
    }
    ...
    public void setType(Type newType) {
        ...
        type = newType;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FacadePackage.PROPERTY__TYPE, oldType, type));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case FacadePackage.PROPERTY__VIEWABLE:
                return isViewable();
            case FacadePackage.PROPERTY__TYPE:
