...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Traverse Filterable List Navigation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.psm.facade.impl.TraverseFilterableListNavigationImpl#isFilterable <em>Filterable</em>}</li>
 *   <li>{@link hu.blackbelt.judo.meta.psm.facade.impl.TraverseFilterableListNavigationImpl#getTraverseExpr <em>Traverse Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TraverseFilterableListNavigationImpl extends TraverseListNavigationImpl implements TraverseFilterableListNavigation {
    /**
     ...
     * @generated
     */
    protected TraverseFilterableListNavigationImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return FacadePackage.Literals.TRAVERSE_FILTERABLE_LIST_NAVIGATION;
    }
    ...
    public void setFilterable(boolean newFilterable) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FacadePackage.TRAVERSE_FILTERABLE_LIST_NAVIGATION__FILTERABLE, oldFilterable, filterable));
    }
    ...
    public void setTraverseExpr(String newTraverseExpr) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, FacadePackage.TRAVERSE_FILTERABLE_LIST_NAVIGATION__TRAVERSE_EXPR, oldTraverseExpr, traverseExpr));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case FacadePackage.TRAVERSE_FILTERABLE_LIST_NAVIGATION__FILTERABLE:
                return isFilterable();
            case FacadePackage.TRAVERSE_FILTERABLE_LIST_NAVIGATION__TRAVERSE_EXPR:
...
} //TraverseFilterableListNavigationImpl
