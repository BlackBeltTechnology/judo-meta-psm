...
public interface FacadePackage extends EPackage {
     ...
     * @ordered
     */
    int PROPERTY__PATH = NamespacePackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int PROPERTY__FUNCTION = NamespacePackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int PROPERTY__ORDER_INDEX = NamespacePackage.NAMED_ELEMENT_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
    int PROPERTY__ORDER_DIRECTION = NamespacePackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
     ...
     * @ordered
     */
    int PROPERTY__FILTERABLE = NamespacePackage.NAMED_ELEMENT_FEATURE_COUNT + 4;
     ...
     * @ordered
     */
    int PROPERTY__VIEWABLE = NamespacePackage.NAMED_ELEMENT_FEATURE_COUNT + 5;
     ...
     * @ordered
     */
    int PROPERTY__TYPE = NamespacePackage.NAMED_ELEMENT_FEATURE_COUNT + 6;
     ...
     * @ordered
     */
    int LINK__EXPAND = NamespacePackage.NAMED_ELEMENT_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
    int LINK_FEATURE_COUNT = NamespacePackage.NAMED_ELEMENT_FEATURE_COUNT + 3;
    ...
    /**
     * Returns the meta object for the reference '{@link hu.blackbelt.judo.meta.psm.facade.Property#getType <em>Type</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the reference '<em>Type</em>'.
     * @see hu.blackbelt.judo.meta.psm.facade.Property#getType()
     * @see #getProperty()
     * @generated
     */
    ...
    /**
     * Returns the meta object for the attribute '{@link hu.blackbelt.judo.meta.psm.facade.Link#isExpand <em>Expand</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the attribute '<em>Expand</em>'.
     * @see hu.blackbelt.judo.meta.psm.facade.Link#isExpand()
     * @see #getLink()
     * @generated
     */
    EAttribute getLink_Expand();
    ...
    interface Literals {
         ...
         * @generated
         */
        EAttribute LINK__EXPAND = eINSTANCE.getLink_Expand();
